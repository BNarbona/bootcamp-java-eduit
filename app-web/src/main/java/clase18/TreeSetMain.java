...
public class TreeSetMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("Ingrese el orden: \n1-Por fecha Ascendente\n2-Por Fecha Descendente\n3-Por Fecha, Banco y cmc7");
		
		int index = teclado.nextInt();
		
		Comparator<Cheque> orden =  null;
		
		switch(index) {
			case 1: 
				 orden = new FechaPagoAsc();
				break;
			case 2:
				orden = new FechaPagoDesc();
				break;
			case 3:
				orden = new ChequeComparator();
				break;
			default:
				break;
		...
		Collection<Cheque> cheques = new TreeSet<>(orden);
		cheques.add(c1);
		cheques.add(c2);
		cheques.add(c3);
		cheques.add(c4);
