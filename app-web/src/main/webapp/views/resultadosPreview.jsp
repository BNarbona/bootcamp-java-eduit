       ...
       <div class="container">
		<section>     
	       <div class="row">
	       		<div class="col-12">
	       			<h1>Listado Ok</h1>
			         	<%Collection<Articulo> lista = (Collection<Articulo>)request.getSession().getAttribute(AttributesEnum.ARTICULOS_OKS.getValue());%>
			         	<table class="table">
						  <thead>
						    <tr>
						      <th scope="col">ID</th>
			 ...
			 <div class="row">
	       		<div class="col-12">
	       			<h1>Listado fail</h1>
			         	<%Collection<ArticuloDTO> listaFail = (Collection<ArticuloDTO>)request.getSession().getAttribute(AttributesEnum.ARTICULOS_FAILS.getValue());%>
			         	<table class="table">
						  <thead>
						    <tr>
						      <th scope="col">T&iacutetulo</th>
						  ...
						  <tbody>
							  <%for(ArticuloDTO fila:listaFail){ %>
								    <tr>
								      <td><%=fila.getTitle()%></td>
								      <td><%=fila.getCode()%></td>
								      <td><%=fila.getPrice()%></td>
				...
				<div class="row">
					<div class="col-md-12 col-lg-6">
							<%
							 if (!listaFail.isEmpty()){
							%>	
							<label>Exportar Archivo</label>
							  <form action="<%=request.getContextPath()%>/controller/ExportarController">
